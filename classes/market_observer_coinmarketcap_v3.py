...
class MarketObserver:
    ...
    def is_candidate(self, currency_data):
        ...
        change_15m = currency_data["change_15m"]
        change_30m = currency_data["change_30m"]
        change_1h = currency_data["change_1h"]
        change_24h = currency_data["change_24h"]

        if change_5m is None or change_10m is None or change_15m is None or change_30m is None: 
            return False

        return change_5m > 0 and change_10m > change_5m and change_15m > change_10m and change_30m > change_15m and change_1h > change_30m and change_24h > change_1h
