from classes.market_observer_coinmarketcap_v3 import MarketObserver
...
while True:
    ...
    if current_currency_symbol is None:
        ...
        elif current_currency_data["change_30m"] is not None and current_currency_data["change_30m"] < 0:
            log(f"EVENT: {current_currency_symbol} is making losses ({current_currency_data['change_30m']} %)")
            last_purchase_time = None
