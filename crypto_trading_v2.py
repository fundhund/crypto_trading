from classes.market_observer_coinmarketcap_v2 import MarketObserver
...
def print_candidates():
    ...
    if not market_observer.candidates:
        ...
        for count, candidate in enumerate(market_observer.candidates):
            ...
            c_10m = str(round(candidate['change_10m'], 2)).rjust(4)
            c_20m = str(round(candidate['change_20m'], 2)).rjust(4)
            c_30m = str(round(candidate['change_30m'], 2)).rjust(4)
